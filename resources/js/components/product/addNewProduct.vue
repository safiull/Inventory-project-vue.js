				...
				<div class="col-11 m-auto">
					<div class="card">
						<div class="card-header bg-dark">
							<h3 class="display-5 float-left"><i class="fa fa-user-plus"></i> Add product</h3>
							<router-link class="btn btn-info btn-sm float-right" to="all-product"><i class="fa fa-users"></i> Product list</router-link>
						</div>
						<div class="card-body">
