				...
				<div class="col-11 m-auto">
					<div class="card">
						<div class="card-header bg-dark">
							<h3 class="display-5 float-left"><i class="fa fa-user-plus"></i> Update Employee</h3>
							<router-link to="/all-employee" class="btn btn-info btn-sm float-right"><i class="fa fa-users"></i> Employee list</router-link>
						</div>
						<div class="card-body">
